...
![\\label{fig:item}: Ejemplo de Pregunta con Múltiples Ítemes en ELSOC](/Users/Elisa/Documents/GitHub/Manuales-ELSOC/Imagenes/Figura_item.png)
...
::: {.base}  
**variableenbase** Fraseo completo de  la pregunta y/o el ítem. Incluyendo instrucciones específicas a éste.[*Etiqueta de variable*]
...
::: {.base}  
**t2_01** *Este es el barrio ideal para mi*
...
::: {.base}  
**c12_09esp**  A continuación le voy a leer una lista de organizaciones voluntarias. Para cada una de ellas, ¿podría decirme si es miembro activo, miembro inactivo, o no es miembro de estas organizaciones? **Otra, especifique:** *[Especifique]*
...
::: {.base}  
**m37_01**  ¿Cuántos hijos hombres e hijas mujeres ha tenido usted en su vida? (Anote el número respectivo:) 1) Número de hijos hombres. *[Numero de hijos hombres:]*
