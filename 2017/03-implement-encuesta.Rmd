...
cdf %>%
  ...
  column_spec(c(2,3,4,5), width = "1cm") %>%
...
![\\label{fig:atricion}: Diseño Muestral de ELSOC según Ola](/Users/Elisa/Documents/GitHub/Manuales-ELSOC/Imagenes/attrition_01.png)
...
atricion %>%
  kable(booktabs = TRUE,  caption="\\label{tab:atricion2}Análisis de Atrición según Atributos Claves") %>%
  column_spec(c(1), width = "2cm") %>%
...
![\\label{fig:atricion2}: Diseño Muestral de ELSOC según Ola](/Users/Elisa/Documents/GitHub/Manuales-ELSOC/Imagenes/Sample_Design.png)
