...
```{r echo=FALSE, fig.align='center', fig.height=1, out.height="80%", out.width="80%"}
...
caract_hogar%>%
  kable(booktabs = TRUE, longtab=T, caption="\\label{tab:estratos}Discrepancias en Caracterización del Hogar, Primera Ola ELSOC") %>%
