...
```{r hhs, echo=FALSE, message=FALSE, warning=FALSE}
library(pacman)
pacman::p_load(tidyverse,knitr,kableExtra,dplyr,tinytex)
...
```{r viviendas, echo=FALSE, message=FALSE, warning=FALSE}
