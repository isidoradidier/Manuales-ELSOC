...
temas2018s_c1 <- c("Temas de discusión pública (c37), percepción de corrupción (c38) y voto retrospectivo 2017 (c39), metas y planes de vida (s30), redes de apoyo al encontrar trabajo (m55 y m56)")

temas2018r_c1 <- c("percepción de corrupción (c38) y voto retrospectivo 2017 (c39)")

temas2018no_c1 <- c("Elección residencial (t12 y t13), redes cercanas (r1_nredes), temas constitucionales (c26, c27, c29 y c30), conflicto de clase (excluido solo de muestra seguimiento), amigos del colegio(d7, d8, d9), preferencias ideológicas (igualdad-libertad) (d10), conducta saludable (s5), sistema de salud (s6, s7, s8, s11), estado de salud (s9, s10), personalidad (s12), consumo cultural (s13, s14, s15, s16, s17, s18, s19), migración(m15), caracterización del hogar (m48, m49, m50, m51, m52, m46), detalles de nivel educacional (m50, m51)")

dif_temas_c1 <- data.frame(temas2018s_c1,temas2018r_c1,temas2018no_c1)

knitr::kable(dif_temas_c1,
  format = "html",
  booktabs = TRUE,
  col.names = c("Temas agregados muestra seguimiento 2018","Temas agregados muestra refresco 2018","Temas no incluidos 2018 respecto al 2017"),
  align = c("lll"),
  caption = "Diferencias temáticas entre cuestionario ola 2 (2017) y ola 3 (2018)")
```

```{r Cuadro 2, eval=FALSE, include=FALSE}
temas2018s_c1 <- c("Muestra de seguimiento y muestra refresco")
