...
# Implementación de la Encuesta {#implement_encuesta}
...
![(#fig:atricion) Diseño Muestral de ELSOC según Ola](../Imagenes/attrition_01.png){width=70%}
...
```{r Librerías 3, include=FALSE}
library(pacman)
pacman::p_load(tidyverse,knitr,kableExtra,dplyr,tinytex)
```

```{r Cuadro 7, echo=FALSE}
atricion_atributo <- tibble("Variable" =
                            c("Hombre","Mujer","Norte","Centro","Sur","Metropolitana","18-29 años","30-49 años",
                              "50-64 años","65 años y más","Total"),
                    "2016-2017" = 
                            c("81.8","86.3","85.8","84.5","85.8","83.4","74.1","81.1","91.3","92.7","84.5"),
                    "2017-2018" = 
                            c("88.2","91.3","91.9","92.7","90.6","85.6","71.7","88.2","94.6","103.6","90.1"),
                    "2016-2018" = 
                            c("72.1","78.8","78.9","78.4","77.7","71.3","53.2","71.5","86.4","96.0","76.2")) 


atricion_atributo %>%
  kable(booktabs = TRUE,caption="\\label{tab:atricion_atributo}Análisis de Atrición muestra seguimiento según atributos claves") %>%
  column_spec(c(1), width = "3cm") %>%
  column_spec(c(2), width = "3cm") %>%
  column_spec(c(3), width = "3cm") %>%
  column_spec(c(4), width = "3cm") %>%
...
![(#fig:atricion2) Diseño Muestral de ELSOC según Ola](../Imagenes/Sample_Design.png){width=70%}
...
<!--chapter:end:04-acceso-datos.Rmd-->
